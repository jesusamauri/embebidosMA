...
//-------------BSC0_BASE-------------------
#define BSC0_CTL			0 //control 
#define BSC0_STAT			1 //status register
#define BSC0_DLEN			2 //Data Length
#define BSC0_SADD			3 //Slave address
#define BSC0_FIFO			4 //data FIFO
#define BSC0_DIV			5 //CLK divider
#define BSC0_DEL			6 //data delay
#define BSC0_CLKT			7 //CLK stretch timeout
//-------------BSC0_BASE-------------------
